    ...
    return (
      <div>
        <nav className="w-20 z-10 hidden fixed left-0 top-0 flex-col h-full bg-green-800 text-white shadow-lg overflow-auto md:flex">
          ...
          <button onClick={onToggleClick} aria-label="Expand Navigation" className="px-5 h-16 mt-auto flex items-center justify-center flex-shrink-0 bg-green-900 hover:bg-yellow-600 focus:bg-yellow-700">
        ...
        <nav className="z-10 h-16 fixed top-0 flex w-screen bg-green-800 text-white shadow-lg md:hidden">
          ...
          <button onClick={onToggleClick} aria-label="Expand Navigation" className="h-16 px-5 ml-auto flex items-center justify-center flex-shrink-0 bg-green-900 hover:bg-yellow-600 focus:bg-yellow-700">
