  ...
  return (
    <section>
      ...
      <div className="overflow-auto">
        <table className="border border-gray-400 border-collapse w-full text-gray-700">
          <thead>
          <tr>
          ...
          <tr>
            <td className="border border-gray-400 p-3" colSpan="2">
              The number of generations required for a species to become extinct when there is no improvement on
              fitness.
            </td>
          </tr>
          <tr>
