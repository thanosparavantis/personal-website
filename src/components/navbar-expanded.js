...
const NavbarExpanded = ({ onLinkClick, onToggleClick }) => (
  <nav className="z-50 fixed top-0 left-0 w-screen h-screen flex flex-col bg-green-700 text-white shadow-lg overflow-auto md:w-auto">
    ...
    <button onClick={onToggleClick}
            className="flex items-center justify-center flex-shrink-0 px-5 h-16 hover:bg-green-900
            bg-green-800 active:bg-green-900 focus:outline-none focus:shadow-outline md:mt-auto">
