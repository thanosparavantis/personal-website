...
import {faAngleDoubleDown, faCode, faEnvelopeOpenText, faQuestionCircle} from "@fortawesome/free-solid-svg-icons";
...
export default function HomePage() {
  return (
    <>
      ...
      />
      <main>
        <div className="flex items-center justify-center lg:ml-72 px-3">
          <section itemScope
        ...
        <div className="bg-gray-100 flex items-center justify-center lg:ml-72 px-3 border-t shadow">
          <section className="container max-w-3xl min-h-screen mt-16 mb-5 flex flex-col items-center justify-center">
            <h2 className="text-3xl text-gray-900 font-bold">
              Let's connect
              <FontAwesomeIcon icon={faAngleDoubleDown} className="ml-6"/>
            </h2>
            <div className="flex md:flex-row flex-col items-center justify-center gap-3 mt-5 mb-16 font-bold text-sm">
