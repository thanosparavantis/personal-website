    ...
    <BackgroundImage Tag="div" fluid={data.background.childImageSharp.fluid}>
      ...
      <div className="p-5 relative flex flex-col items-center justify-center w-full h-screen">
        ...
        <div className="flex flex-col mt-6 w-full md:flex-row max-w-lg">
          <a href="https://twitter.com/thparavantis" title="Visit my Twitter profile." className="block w-full text-center mb-2 px-5 py-2 text-white bg-blue-600 rounded-lg shadow-lg hover:bg-blue-500 focus:outline-none focus:shadow-outline md:mb-0 md:mr-4">
            <FontAwesomeIcon icon={faTwitter} className="mr-2" size="lg"/>
            Twitter
          </a>
          <a href="https://www.linkedin.com/in/thanosparavantis" title="Visit my LinkedIn profile." className="block w-full text-center mb-2 px-5 py-2 text-white bg-blue-800 rounded-lg shadow-lg hover:bg-blue-700 focus:outline-none focus:shadow-outline md:mb-0 md:mr-4">
            <FontAwesomeIcon icon={faLinkedinIn} className="mr-2" size="lg"/>
            LinkedIn
          </a>
          <a href="https://github.com/thanosparavantis" title="Visit my GitHub profile." className="block w-full text-center px-5 py-2 text-white bg-gray-700 rounded-lg shadow-lg hover:bg-gray-600 focus:outline-none focus:shadow-outline">
